...
object KtCommands {
    ...
    val HEAD_ADMIN = Predicate<Player> { it.playerRights.isAdminOrGreater(it) }
    val COMMUNITY_MANAGER = Predicate<Player> { it.playerRights.isOwner(it) }
    val MOD = Predicate<Player> { it.playerRights.isModerator() || it.playerRights.isAdminOrGreater(it) }
    val HEAD_MODERATOR = Predicate<Player> { it.playerRights.isModerator() || it.playerRights.isAdminOrGreater(it) }
