        ...
        try {
            ...
            if (killer != null) {
                respawnTimer -= switch (killer.getMemberRights()) {
                    case NONE -> 0;
                    case RUBY -> Utils.secondsToTicks(2);
                    case SAPPHIRE -> Utils.secondsToTicks(4);
                    case EMERALD -> Utils.secondsToTicks(6);
                    case DIAMOND -> Utils.secondsToTicks(8);
                    case DRAGONSTONE, ONYX, ZENYTE -> Utils.secondsToTicks(10);
                };
