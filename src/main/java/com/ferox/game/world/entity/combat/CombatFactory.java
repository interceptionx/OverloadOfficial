...
import com.ferox.game.content.skill.impl.fletching.impl.Bolt;
...
public class CombatFactory {
    ...
    public static void unfreezeWhenOutOfRange(Mob mob) {
        ...
        if (freezer.tile().getChevDistance(mob.tile()) > 10 || !freezer.isRegistered()) {//off screen or unregistered
