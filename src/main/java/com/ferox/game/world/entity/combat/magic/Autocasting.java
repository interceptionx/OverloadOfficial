...
public class Autocasting {
    ...
    public static final Set<Integer> ANCIENT_SPELL_AUTOCAST_STAFFS = Set.of(KODAI_WAND, MASTER_WAND,
        ANCIENT_STAFF,NIGHTMARE_STAFF,VOLATILE_NIGHTMARE_STAFF,ELDRITCH_NIGHTMARE_STAFF, TOXIC_STAFF_OF_THE_DEAD, TOXIC_STAFF_OF_THE_DEAD_C, ELDER_WAND, ELDER_WAND_RAIDS, STAFF_OF_THE_DEAD, STAFF_OF_LIGHT, THAMMARONS_STAFF_C, ANATHEMATIC_WAND);
