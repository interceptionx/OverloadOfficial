...
public class ShowDidYouKnowCommand implements Command {
    ...
    public void execute(Player player, String command, String[] parts) {
        ...
        messages.set(0, "[<col=" + Color.GREEN.getColorValue() + ">Did you know?</col>]: <col="+Color.PURPLE.getColorValue()+">" + messages.get(0) + (messages.size() > 1 ? "..." : "")); //Maroon and Purple are the best colours for this type of message
