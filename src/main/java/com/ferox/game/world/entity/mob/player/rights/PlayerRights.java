...
public enum PlayerRights {
    ...
    HEAD_MODERATOR("Head Moderator", 1313, 1, 4),

    ADMINISTRATOR("Administrator", 495, 2, 5),

    HEAD_ADMINISTRATOR("Head Administrator", 1314, 2, 6),

    COMMUNITY_MANAGER("Community Manager", 1315, 4, 7),

    DEVELOPER("Developer", 497, 4, 8),
    ...
    SECURITY_MODERATOR("Security Mod", 1861, 1, 20),

    EVENT_MANAGER("Community Manager", 1861, 1, 21),
    ;
