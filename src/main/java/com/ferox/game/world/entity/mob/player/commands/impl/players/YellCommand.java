...
public class YellCommand implements Command {
    ...
    private static int getYellDelay(Player player) {
        ...
        switch (memberRights) {
            case RUBY -> yellTimer = 30;
            case SAPPHIRE -> yellTimer = 20;
            case EMERALD -> yellTimer = 10;
            case DIAMOND -> yellTimer = 5;
            case DRAGONSTONE, ONYX, ZENYTE -> yellTimer = 0;
        }
    ...
    public void execute(Player player, String command, String[] parts) {
        ...
        if (player.getMemberRights().getRightValue() < MemberRights.RUBY.getRightValue() && player.getPlayerRights() == PlayerRights.PLAYER && kc < 50) {
