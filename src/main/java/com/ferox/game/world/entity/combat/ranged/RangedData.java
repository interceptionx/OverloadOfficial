...
//TODO change random ids with identifiers
    ...
    private static int boltSpecialChance(MemberRights memberRights, boolean always_spec) {
        int percentage = 10;
        switch (memberRights) {
            case RUBY -> percentage = 1;
            case SAPPHIRE -> percentage = 2;
            case EMERALD -> percentage = 3;
            case DIAMOND -> percentage = 4;
            case DRAGONSTONE -> percentage = 5;
            case ONYX -> percentage = 6;
            case ZENYTE -> percentage = 7;
        }
