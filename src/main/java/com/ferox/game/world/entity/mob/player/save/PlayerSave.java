...
public class PlayerSave {
    ...
    public static final Gson SERIALIZE = new GsonBuilder().registerTypeAdapter(LocalDateTime.class, (JsonDeserializer<LocalDateTime>) (json, type, jsonDeserializationContext) ->
