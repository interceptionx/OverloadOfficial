            ...
            if (valid) {
                ...
                if(killer.tile().insideRiskArea()) {
                    ...
                    switch (killer.getMemberRights()) {
                        case MEMBER -> increaseBy = 1;
                        case SUPER_MEMBER -> increaseBy = 1;
                ...
                if(World.getWorld().rollDie(1000,1)) {
                    ...
                    killer.message(Color.PURPLE.wrap("You've found an Elite pet mystery box searching the corpse of "+target.getUsername()+"."));
