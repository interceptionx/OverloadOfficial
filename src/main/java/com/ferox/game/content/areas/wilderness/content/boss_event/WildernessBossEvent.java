...
public class WildernessBossEvent {
     ...
     */
    private static final BossEvent[] EVENT_ROTATION = {BossEvent.GRIM, BossEvent.ZOMBIES_CHAMPION, BossEvent.SKOTIZO, BossEvent.TEKTON};
    ...
    public void startBossEvent() {
        ...
        if (activeEvent != BossEvent.NOTHING) {
            ...
            World.getWorld().sendWorldMessage("<col=6a1a18><img=1409> " + activeEvent.description + " has been spotted " + activeEvent.spawnLocation(boss.tile()) + " in level " + WildernessArea.wildernessLevel(boss.tile()) + " Wild!");
            World.getWorld().sendWorldMessage("<col=6a1a18>It despawns in 60 minutes. Hurry!");

            // Broadcast it
            World.getWorld().sendBroadcast("<img=1409>" + activeEvent.description + " has been spotted " + activeEvent.spawnLocation(boss.tile()) + " in level " + WildernessArea.wildernessLevel(boss.tile()) + " Wild!");
        }
    }
