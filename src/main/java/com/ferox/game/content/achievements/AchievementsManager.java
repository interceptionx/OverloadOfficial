...
public class AchievementsManager {
    ...
    public static void activate(Player player, Achievements achievement, int increaseBy) {
        ...
        if (player.achievements().get(achievement) >= achievement.getCompleteAmount()) {
            ...
            World.getWorld().sendWorldMessage(format("[<col="+ Color.MEDRED.getColorValue()+">Achievement</col>]: %s just completed the %s achievement.", (PlayerRights.getCrown(player) + player.getUsername()), achievement.getName()));
