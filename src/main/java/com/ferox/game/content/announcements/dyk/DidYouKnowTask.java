...
public class DidYouKnowTask extends Task {
    ...
    public void execute() {
        ...
        messages.set(0, "<img=1388><col="+Color.DARK_GREEN.getColorValue()+">" + messages.get(0) + (messages.size() > 1 ? "..." : "")); //Maroon and Purple are the best colours for this type of message
