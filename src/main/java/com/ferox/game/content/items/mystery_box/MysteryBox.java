...
public abstract class MysteryBox {
    ...
    public static void load() {
        ...
        MysteryBox PRESENT = new PresentMysteryBox();
        MysteryBox MOLTEN_MYSTERY_BOX = new MoltenMysteryBox();
        ...
        MYSTERY_BOXES.put(PRESENT.mysteryBoxId(), PRESENT);
        MYSTERY_BOXES.put(MOLTEN_MYSTERY_BOX.mysteryBoxId(), MOLTEN_MYSTERY_BOX);
    }
