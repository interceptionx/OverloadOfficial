...
public class DoubleDropLamp extends PacketInteraction {
    ...
    private int ticks(MemberRights memberRights) {
        ...
        switch (memberRights) {
            ...
            case RUBY -> ticks = 6500;//One hour and 5 minutes
            case SAPPHIRE -> ticks = 7000;//One and 10 minutes
            case EMERALD -> ticks = 7500;//One hour and 15 minutes
            case DIAMOND -> ticks = 9000;//One hour and 30 minutes
            case DRAGONSTONE -> ticks = 10500;//One hour and 45 minutes
            case ONYX -> ticks = 11000;//One hour and 50 minutes
            case ZENYTE -> ticks = 11500;//One hour and 55 minutes
        }
        return ticks;
    }
