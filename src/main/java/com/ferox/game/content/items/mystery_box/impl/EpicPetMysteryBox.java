...
public class EpicPetMysteryBox extends PacketInteraction {
    ...
    public static void open(Player player) {
        if(player.inventory().contains(EPIC_PET_BOX)) {
            ...
            String worldMessage = "<img=1863><shad=0>[<col=" + Color.RED.getColorValue() + ">Elite pet mystery box</col>]</shad=0>:<col=FF0000> " + player.getUsername() + " received a <shad=0>" + reward.name()  + Color.BLACK.tag() + "!";
