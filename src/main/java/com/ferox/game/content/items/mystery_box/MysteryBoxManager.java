...
public class MysteryBoxManager {
    ...
    public void reward() {
        ...
        if (sendWorldMessage) {
            String worldMessage = "<img=1863><shad=0>[<col=" + Color.RED.getColorValue() + ">" + box.name() + "</col>]</shad=0>:<col=FF0000> " + player.getUsername() + " received " + plural + " <shad=0>" + reward.unnote().name() + Color.BLACK.tag() + "!";
