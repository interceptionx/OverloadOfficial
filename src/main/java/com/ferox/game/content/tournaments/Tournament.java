...
public class Tournament {
    ...
    public void checkForWinner() {
        if (fighters.size() == 1) {
            ...
            World.getWorld().sendWorldMessage(format(Color.MEDRED.getColorValue() + ">Tournament</col>]: %s has won the %s tournament!", winner.getUsername(), fullName()));
            logger.info(format("<img=1046>[<col=" + Color.MEDRED.getColorValue() + ">Tournament</col>]: %s has won the %s tournament!", winner.getUsername(), fullName()));
    ...
    private Item setRewards() {
        var possible_rewards = new Item[] {new Item(FIVE_DOLLAR_BOND), new Item(MYSTERY_TICKET, 1)};
