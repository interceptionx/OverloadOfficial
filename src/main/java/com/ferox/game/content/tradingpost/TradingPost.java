    ...
    public static boolean handleSellingItem(Player player, int interfaceId, int itemId, long amount) {
        try {
            ...
            switch (player.getMemberRights()) {
                case RUBY -> totalSalesAllowed = 10;
                case SAPPHIRE -> totalSalesAllowed = 12;
                case EMERALD -> totalSalesAllowed = 14;
                case DIAMOND -> totalSalesAllowed = 16;
                case DRAGONSTONE, ONYX, ZENYTE -> totalSalesAllowed = 25;
            }
