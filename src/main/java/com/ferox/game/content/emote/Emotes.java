...
import static com.ferox.game.content.items.equipment.max_cape.MaxCape.FROST_IMBUED_MAX_CAPE;
    ...
    public static boolean doEmote(Player player, int button) {
        ...
        if (button == 19052) {
            ...
            switch (capeid) {
                ...
                case MAX_CAPE, MAX_CAPE_13282, FIRE_MAX_CAPE, SARADOMIN_MAX_CAPE, ZAMORAK_MAX_CAPE, GUTHIX_MAX_CAPE, ACCUMULATOR_MAX_CAPE, MAX_CAPE_13342, ARDOUGNE_MAX_CAPE, INFERNAL_MAX_CAPE_21285, IMBUED_SARADOMIN_MAX_CAPE, IMBUED_ZAMORAK_MAX_CAPE, IMBUED_GUTHIX_MAX_CAPE, ASSEMBLER_MAX_CAPE, MYTHICAL_MAX_CAPE, FROST_IMBUED_MAX_CAPE-> {
                    player.animate(7121);
                    player.graphic(1286);
                }
            }
